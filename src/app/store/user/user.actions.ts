...
export const loadUsersSuccess = createAction(
  '[User API] loadUsersSuccess',
  props<{ users: User[] }>()
)
export const loadUsersFailure = createAction(
  '[User API] loadUsersFailure',
  props<{ error: Error }>()
)

export const registerUser = createAction(
  '[User Component] registerUser',
  props<{ user: UserRegistration }>()
)
export const registerUserSuccess = createAction(
  '[User API] registerUserSuccess',
  props<{ createdUser: User }>()
)
export const registerUserFailure = createAction(
  '[User API] registerUserFailure',
  props<{ error: Error }>()
)

export const signInUser = createAction(
  '[User Component] signInUser',
  props<{ body: { username: string, password: string } }>()
)
export const signInUserSuccess = createAction(
  '[User API] signInUserSuccess',
  props<{ currentUser: User, isLoggedIn: string, userId: string }>()
)
export const signInUserFailure = createAction(
  '[User API] signInUserFailure',
  props<{ user: null, token: null, error: Error }>()
)

export const getCurrentUser = createAction('[User Component] getCurrentUser')
export const getCurrentUserSuccess = createAction(
  '[User API] getCurrentUserSuccess',
  props<{ currentUser: User, isLoggedIn: string | null }>()
)
export const getCurrentUserFailure = createAction(
  '[User API] getCurrentUserFailure',
  props<{ currentUser: null, error: Error }>()
)
